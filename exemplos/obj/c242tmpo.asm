...
;   a PIC18C242. Copy this file into your project directory and modify or     *
;   add to it as needed. Create a project with MPLINK as the language tool    *
;   for the hex file. Add this file and the 18C242.LKR file to the project.   *
;                                                                             *
...
;******************************************************************************
;                                                                             *
;    Files required:         P18C242.INC                                      *
;                            18C242.LKR                                       *
;                                                                             *
;******************************************************************************

	LIST P=18C242, F=INHX32	;directive to define processor and file format
	#include <P18C242.INC>	;processor specific variable definitions
