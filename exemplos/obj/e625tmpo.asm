...
;   generation on the PICmicro PIC16CE625. This file contains the     *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16ce625.lkr file will also be required for this file to       *
...
;                                                                     *
;   If interrupts are used, as in this template file, the 16ce625.lkr *
...
;**********************************************************************
	...
	list      p=16ce625          ; list directive to define processor
	#include <p16ce625.inc>      ; processor specific variable definitions
