...
;   generation on the PICmicro PIC16C65B. This file contains the      *
...
;**********************************************************************
	...
	list      p=16c65b            ; list directive to define processor
	#include <p16c65b.inc>        ; processor specific variable definitions
