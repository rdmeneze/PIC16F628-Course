...
;   generation on the PICmicro PIC16C72. This file contains the       *
...
;**********************************************************************
	...
	list      p=16c72             ; list directive to define processor
	#include <p16c72.inc>         ; processor specific variable definitions
