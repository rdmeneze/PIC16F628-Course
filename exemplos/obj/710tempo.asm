...
;   generation on the PICmicro PIC16C710. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16c710.lkr file will also be required for this file to        *
...
;                                                                     *
;	If interrupts are used, as in this template file, the 16c710.lkr  *
...
;**********************************************************************
	...
	list      p=16c710            ; list directive to define processor
	#include <p16c710.inc>        ; processor specific variable definitions
