...
;   generation on the PICmicro AP7675. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the AP7675.lkr file will also be required for this file to        *
...
;                                                                     *
;   If interrupts are used, as in this template file, the AP7675.lkr  *
...
;**********************************************************************
	...
	list		p=AP7675	; list directive to define processor
	#include	<AP7675.inc>	; processor specific variable definitions
