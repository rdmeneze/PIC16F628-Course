...
;   generation on the PICmicro PIC16C74A. This file contains the      *
...
;**********************************************************************
	...
	list      p=16c74a            ; list directive to define processor
	#include <p16c74a.inc>        ; processor specific variable definitions
