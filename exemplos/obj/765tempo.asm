...
;   generation on the PICmicro PIC16C765. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16C765.lkr file will also be required for this file to        *
...
;                                                                     *
;   If interrupts are used, as in this template file, the 16C765.lkr  *
...
;**********************************************************************
	...
	list		p=16c765	; list directive to define processor
	#include	<p16c765.inc>	; processor specific variable definitions
