...
;   generation on the PICmicro PIC16C558. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16C558.lkr file will also be required for this file to        *
...
;                                                                     *
;   If interrupts are used, as in this template file, the 16C558.lkr  *
...
;**********************************************************************
	...
	list		p=16c558	; list directive to define processor
	#include	<p16c558.inc>	; processor specific variable definitions
...
;copies of context saving variables in bank1
INT_VAR1	UDATA	0xA0   
