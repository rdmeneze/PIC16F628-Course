...
;   generation on the PICmicro PIC16C781. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16C781.lkr file will also be required for this file to        *
...
;                                                                     *
;   If interrupts are used, as in this template file, the 16C781.lkr  *
