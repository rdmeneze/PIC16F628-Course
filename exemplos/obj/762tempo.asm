...
;   generation on the PICmicro PIC17C762. This file contains the      *
;   basic code building blocks to build upon. As a project minimum    *
;   the 17c752.lkr file will also be required for this file to        *
...
;   interrupt code is structured for microcontroller mode (up to      *
;   8K words of program memory). If the PIC17C752 PICmicro is to be   *
;   used in the extended microcontroller or microprocessor modes then *
;   the interrupt code structure may require some changes, i.e.,      *
;   use computed long gotos instead of gotos. (See object module      *
;   code template for PICmicro PIC17C766 for this alternate method)   *
;                                                                     *
...
;**********************************************************************
	...
	list p=17c762, f=INHX32	;directive to define processor and file format
	#include <p17c762.inc>	;processor specific variable definitions
