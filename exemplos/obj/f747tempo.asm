...
;   generation on the PICmicro PIC16F747. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16F747.lkr file will also be required for this file to        *
...
;                                                                     *
;   If interrupts are used, as in this template file, the 16F747.lkr  *
...
;**********************************************************************
	...
	list		p=16f747		; list directive to define processor
	#include	<p16f747.inc>	; processor specific variable definitions
