...
;   generation on the PICmicro PIC16F767. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16F767.lkr file will also be required for this file to        *
...
;                                                                     *
;   If interrupts are used, as in this template file, the 16F767.lkr  *
