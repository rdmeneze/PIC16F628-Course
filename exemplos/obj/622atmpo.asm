...
;   generation on the PICmicro PIC16C622A. This file contains the     *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16c622a.lkr file will also be required for this file to       *
...
;                                                                     *                         
;	If interrupts are used, as in this template file, the 16c622a.lkr *
...
;**********************************************************************
	...
	list      p=16c622a          ; list directive to define processor
	#include <p16c622a.inc>      ; processor specific variable definitions
