...
;   generation on the PICmicro PIC16C715. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16c715.lkr file will also be required for this file to        *
...
;                                                                     *
;	If interrupts are used, as in this template file, the 16c715.lkr  *
...
;**********************************************************************
	...
	list      p=16c715            ; list directive to define processor
	#include <p16c715.inc>        ; processor specific variable definitions
