...
;   generation on the PICmicro PIC16C717. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16c717.lkr file will also be required for this file to        *
...
;                                                                     *
;   If interrupts are used, as in this template file, the 16c717.lkr  *
...
;**********************************************************************
	...
	list      p=16c717            ; list directive to define processor
	#include <p16c717.inc>        ; processor specific variable definitions
