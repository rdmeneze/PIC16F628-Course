...
;   generation on the PICmicro rfPIC12C509AG. This file contains the  *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 12C509AG.lkr file will also be required for this file to      *
...
;**********************************************************************
	...
	list      p=RF509AG    ; list directive to define processor
	#include <RF509AG.inc>       ; processor specific variable definitions
