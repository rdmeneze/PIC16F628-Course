...
;   generation on the PICmicro PIC16C433. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16C433.lkr file will also be required for this file to        *
...
;                                                                     *
;   If interrupts are used, as in this template file, the 16C433.lkr  *
...
;**********************************************************************
	...
	list		p=16c433	; list directive to define processor
	#include	<p16c433.inc>	; processor specific variable definitions
	
	__CONFIG   _CP_OFF & _WDT_OFF & _MCLRE_ON & _PWRTE_ON & _EXTRC_OSC_CLKOUT
