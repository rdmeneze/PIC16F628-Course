...
;   generation on the PICmicro PIC17C766. This file contains the      *
...
;**********************************************************************
	...
	list p=17c766, f=INHX32	;directive to define processor and file format
	#include <p17c766.inc>	;processor specific variable definitions
