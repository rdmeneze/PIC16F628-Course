...
;   generation on the PICmicro PIC12CE518. This file contains the     *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 12c508.lkr file will also be required for this file to        *
...
;**********************************************************************
	...
	list      p=12ce518           ; list directive to define processor
	#include <p12ce518.inc>       ; processor specific variable definitions
