...
;   generation on the PICmicro PIC16C62B. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16c62.lkr file will also be required for this file to         *
...
;                                                                     *                         
;	If interrupts are used, as in this template file, the 16c62.lkr   *
...
;**********************************************************************
	...
	list      p=16c62b            ; list directive to define processor
	#include <p16c62b.inc>        ; processor specific variable definitions
