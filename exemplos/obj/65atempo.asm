...
;   generation on the PICmicro PIC16C65A. This file contains the      *
...
;**********************************************************************
	...
	list      p=16c65a            ; list directive to define processor
	#include <p16c65a.inc>        ; processor specific variable definitions
