...
;   generation on the PICmicro PIC16C782. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16C782.lkr file will also be required for this file to        *
...
;                                                                     *
;   If interrupts are used, as in this template file, the 16C782.lkr  *
...
;**********************************************************************
	...
	list		p=16c782	; list directive to define processor
	#include	<p16c782.inc>	; processor specific variable definitions
	
	__CONFIG _CP_OFF & _WDT_OFF & _BODEN_OFF & _PWRTE_ON & _ER_OSC_CLKOUT & VBOR_25 & _MCLRE_ON
