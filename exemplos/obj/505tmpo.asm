...
;   generation on the PICmicro PIC16C505. This file contains the      *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16c505.lkr file will also be required for this file to        *
...
MAIN    CODE    0x000             ; coding begins here
