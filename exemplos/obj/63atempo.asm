...
;   generation on the PICmicro PIC16C63A. This file contains the      *
...
;**********************************************************************
	...
	list      p=16c63A            ; list directive to define processor
	#include <p16c63a.inc>        ; processor specific variable definitions
