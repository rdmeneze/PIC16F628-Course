...
;   generation on the PICmicro PIC16C73A. This file contains the      *
...
;**********************************************************************
	...
	list      p=16c73a            ; list directive to define processor
	#include <p16c73a.inc>        ; processor specific variable definitions
