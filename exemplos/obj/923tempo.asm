...
;   generation on the PICmicro PIC16C923. This file contains the      *
...
;**********************************************************************
	...
	list      p=16c923            ; list directive to define processor
	#include <p16c923.inc>        ; processor specific variable definitions
