...
;   a PIC18C442. Copy this file into your project directory and modify or     *
;   add to it as needed. Create a project with MPLINK as the language tool    *
;   for the hex file. Add this file and the 18C442.LKR file to the project.   *
;                                                                             *
...
;******************************************************************************
;                                                                             *
;    Files required:         P18C442.INC                                      *
;                            18C442.LKR                                       *
;                                                                             *
;******************************************************************************

	LIST P=18C442, F=INHX32	;directive to define processor and file format
	#include <P18C442.INC>	;processor specific variable definitions
