...
;   generation on the PICmicro PIC16F76. This file contains the       *
;   basic code building blocks to build upon.  As a project minimum   *
;   the 16F76.lkr file will also be required for this file to         *
...
;                                                                     *
;   If interrupts are used, as in this template file, the 16F76.lkr   *
...
;**********************************************************************
	...
	list		p=16f76		; list directive to define processor
	#include	<p16f76.inc>	; processor specific variable definitions
