...
;   generation on the PICmicro PIC17C42. This file contains the       *
;   basic code building blocks to build upon. As a project minimum    *
;   the 17c42.lkr file will also be required for this file to         *
...
;**********************************************************************
	...
	list p=17c42, f=INHX32	;directive to define processor and file format
	#include <p17c42.inc>	;processor specific variable definitions
